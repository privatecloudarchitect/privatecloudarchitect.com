...
rows = [
 ...
 ["identity", "no counter", "identifiers " + m("VMEntityVCID") + " + " + m("VMEntityObjectID") + "; " + P("summary|MOID") + "; " + m("VMEntityInstanceUUID"), "resource identifiers", T(GOLD, "gold"), "the join key: vCenter instance UUID plus MOID; the instance UUID rides along"],
