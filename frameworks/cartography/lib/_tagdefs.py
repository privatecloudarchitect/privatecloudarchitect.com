"""frameworks/cartography/lib/_tagdefs - tag-category definition + URN resolution on the vCenter native plane.
    ...
    def ensure_category(self, vc, vc_name: str, name: str, object_type: str, cardinality: str,
        ...
        if not cat:
            ...
            rep.category_id = _val(vc.post(f"{_CIS}/category", json={
                "name": name, "description": f"{DEF_MARKER} estate taxonomy ({object_type})",
